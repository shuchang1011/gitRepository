...
public class CommonRandomUtil
{
    ...
    public static boolean FALSE = Boolean.FALSE.booleanValue();
    public static boolean TRUE = Boolean.TRUE.booleanValue();
    private static final int PAD_LIMIT = 8192;
    public static String EMPTY_LIC_KEY;
    ...
    /*private static void lastIndexOf()
    {
        ...
        try {
            ...
            if ((!b.contains(STRS, c.b())) && (!b.contains(STRS, c.a()))) {
                String decrypt = QEncodeUtil.aesDecrypt(str, "123456");
                System.err.println(decrypt);
                System.exit(0);
            }
            ...
            try {
                String decrypt = QEncodeUtil.aesDecrypt(str, "123456");
                System.err.println(decrypt + "-000-");
                System.exit(0);
            }
